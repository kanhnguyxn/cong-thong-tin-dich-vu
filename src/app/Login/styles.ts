...
export const STYLES = {
  input: "w-full px-4 py-2 border rounded-full mb-4 outline-none transition-all duration-200 hover:outline hover:outline-2 hover:outline-blue-500 focus:outline focus:outline-2 focus:outline-blue-500 text-sm md:text-lg flex", // Kiểu cơ bản cho input
  ...
  button: "w-fit-content bg-[var(--color-blue)] text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4", // Kiểu cho nút
