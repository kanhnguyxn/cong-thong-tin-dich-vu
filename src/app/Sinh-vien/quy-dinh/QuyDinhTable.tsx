...
export default function QuyDinhTable({data}) {
    ...
    const tableCellStyles ={
        '&[data-column-id="sokyhieu"]': { textAlign: 'left' },
        '&[data-column-id="quydinh"]': { textAlign: 'left' },
        '&[data-column-id="noibanhanh"]': { textAlign: 'center' },
        '&[data-column-id="ngaybanhanh"]': { textAlign: 'center' },
        '&[data-column-id="ngayhieuluc"]': { textAlign: 'center' },
        '&[data-column-id="hieuluc"]': { textAlign: 'center' }
    }
    return (
        <CustomTable columns={columns} data={formattedData} tableCellStyles={tableCellStyles} />
    )
}
